...
function runMigrations(db) {
  // Tables first. Every ALTER below assumes its table exists, and on a fresh
  // install init.js has only created the four original ones — so creating the
  // rest up front is what makes a first run work at all.
  // New feature tables
  db.exec(`
